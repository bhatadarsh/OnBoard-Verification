...
const INDIAN_STATES = [
  ...
  'Uttarakhand','West Bengal','Delhi','Jammu & Kashmir','Ladakh','Other / International',
];

const NATIONALITIES = [
  'Indian','American','British','Australian','Canadian','German','French','Singaporean',
  'Emirati','South African','Japanese','Chinese','Brazilian','Mexican','Other',
];
  ...
  return (
    <div className="step-container">
      ...
      <div className="form-grid">
        ...
        <Field id="mobile" label="Mobile Number" required error={errors.mobile}>
          <input id="mobile" type="tel" placeholder="10-digit number"
            value={data.mobile} onChange={e => set('mobile', e.target.value)}
        ...
        <Field id="nationality" label="Nationality">
          <select id="nationality" value={data.nationality || ''} onChange={e => set('nationality', e.target.value)}>
        ...
        <Field id="pincode" label="Pincode" required error={errors.pincode}>
          <input id="pincode" type="text" placeholder="6-digit pincode"
            value={data.pincode} onChange={e => set('pincode', e.target.value)}
      ...
      <div className="form-field full-width">
        ...
        <textarea id="address" placeholder="Street address, apartment, area..." rows="3"
