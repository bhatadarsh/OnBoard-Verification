                ...
                <div className="jpf-preview-card">
                  ...
                  {form.summary && (
                    <div className="preview-section">
                      <div className="preview-sec-title">Role Summary</div>
                      <div className="preview-sec-content summary">{form.summary}</div>
                    </div>
                  )}

                  {form.responsibilities.some(r => r.trim()) && (
                    <div className="preview-section">
                      <div className="preview-sec-title">Responsibilities</div>
                  ...
                  {(form.primarySkills.some(s => s.trim()) || form.secondarySkills.some(s => s.trim())) && (
                    <div className="preview-section">
                      <div className="preview-sec-title">Skills & Requirements</div>
                      <div className="preview-skills-grid">
                        {form.primarySkills.filter(s => s.trim()).map((s, i) => (
                          <span key={`p-${i}`} className="preview-skill-pill primary">{s}</span>
                        ))}
                        {form.secondarySkills.filter(s => s.trim()).map((s, i) => (
                          <span key={`s-${i}`} className="preview-skill-pill secondary">{s}</span>
                        ))}
                      </div>
                    </div>
                  )}
